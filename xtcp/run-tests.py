...
def main():
    ...
    for testdir in os.listdir('tests'):
        ...
        serverproc = subprocess.Popen(servercmd, shell=True, stdout=serverout, stderr=servererr, env=env, cwd=parentdir)
        ...
        clientproc = subprocess.Popen(clientcmd, shell=True, stdout=clientout, stderr=clienterr, env=env, cwd=parentdir)
