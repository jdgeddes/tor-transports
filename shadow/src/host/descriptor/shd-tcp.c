...
void tcp_retransmitTimerExpired(TCP* tcp) {
    ...
    congestionlog(tcp->congestion, "[CONG-LOSS] %s cwnd=%d ssthresh=%d rtt=%d sndbufsize=%d sndbuflen=%d rcvbufsize=%d rcbuflen=%d retrans=%d ploss=%f", tcp->super.boundString,
...
static void _tcp_logCongestionInfo(TCP* tcp) {
    ...
    congestionlog(tcp->congestion, "[CONG-AVOID] %s cwnd=%d ssthresh=%d rtt=%d "
            "sndbufsize=%"G_GSIZE_FORMAT" sndbuflen=%"G_GSIZE_FORMAT" rcvbufsize=%"G_GSIZE_FORMAT" rcbuflen=%"G_GSIZE_FORMAT" "
            "retrans=%"G_GSIZE_FORMAT" ploss=%f", tcp->super.boundString,
            tcp->congestion->window, tcp->congestion->threshold, tcp->congestion->rttSmoothed,
